...
- `@deepseek-ai/dsh-desktop-app` — requires `connection` · `clientModules` · `loader` ([`packages/bundle/desktop-app/src/index.ts`](../packages/bundle/desktop-app/src/index.ts))
