...
- `@deepseek-ai/dsh-desktop-app` — requires `apiProxy` · `connection` · `clientModules` · `loader` ([`packages/bundle/desktop-app/src/index.ts`](../packages/bundle/desktop-app/src/index.ts))
