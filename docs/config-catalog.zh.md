...
- `@deepseek-ai/dsh-desktop-app` — 需要 `apiProxy` · `connection` · `clientModules` · `loader`（[`packages/bundle/desktop-app/src/index.ts`](../packages/bundle/desktop-app/src/index.ts)）
