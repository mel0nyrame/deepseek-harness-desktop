...
Issues #6, #7, and #8 remain open for interaction parity, Host recovery, and native path actions. Release-grade signed, notarized arm64/x64 artifacts remain issue #9.
