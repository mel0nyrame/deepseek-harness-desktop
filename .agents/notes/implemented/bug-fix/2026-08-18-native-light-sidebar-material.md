...
- Focused tests cover preload forwarding, IPC validation, preference deduplication, and transparent glass CSS. The installed three-launch journey also reads `nativeTheme.themeSource` from Electron main and pins Dark, Light, System, persistence, and Reduce Transparency behavior.
