...
- The evidence journey distinguishes initial sizing from later resize settlement. Initial sizing must match the request or an exact display-work-area clamp; a later wide resize must reach the requested or work-area-limited width and a height between the platform minimum and the requested or work-area-limited maximum, because macOS can reserve additional frame height after repositioning.
