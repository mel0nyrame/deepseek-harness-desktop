...
- [defensive-patterns.md in the frozen monorepo](https://github.com/mel0nyrame/deepseek-harness-desktop/blob/0971b9f0e3e9293e3f76c45b1d72f5789244ccdf/legacy/docs/defensive-patterns.md): subprocess, callback, async-state, and disposal bug classes in the official runtime layers.
- [docs/AGENTS.md in the frozen monorepo](https://github.com/mel0nyrame/deepseek-harness-desktop/blob/0971b9f0e3e9293e3f76c45b1d72f5789244ccdf/legacy/docs/AGENTS.md): documentation placement and prose discipline.
...
- [testing.md in the frozen monorepo](https://github.com/mel0nyrame/deepseek-harness-desktop/blob/0971b9f0e3e9293e3f76c45b1d72f5789244ccdf/legacy/docs/testing.md) and the [quality-gates Agent Note in the frozen tree](https://github.com/mel0nyrame/deepseek-harness-desktop/blob/0971b9f0e3e9293e3f76c45b1d72f5789244ccdf/legacy/.agents/notes/implemented/process/2026-06-11-quality-gates.md): required test tiers and gates.
...
- For bilingual changes, read [translation-rules.md in the frozen tree](https://github.com/mel0nyrame/deepseek-harness-desktop/blob/0971b9f0e3e9293e3f76c45b1d72f5789244ccdf/legacy/docs/i18n/translation-rules.md) and [terminology.md in the frozen tree](https://github.com/mel0nyrame/deepseek-harness-desktop/blob/0971b9f0e3e9293e3f76c45b1d72f5789244ccdf/legacy/docs/i18n/terminology.md); bilingual pairs follow the [pairing rule](../../notes/README.md) and are outside automatic review.
...
3. **Core type docs match.** Changes to spine or seam vocabulary update the appropriate [subsystems page in the frozen monorepo](https://github.com/mel0nyrame/deepseek-harness-desktop/blob/0971b9f0e3e9293e3f76c45b1d72f5789244ccdf/legacy/docs/subsystems/README.md) when the vocabulary is official-core; desktop-owned vocabulary is documented in the owning package README.
...
- **Lifecycle and concurrency:** for async setup, callbacks, processes, or teardown, apply [defensive-patterns.md in the frozen monorepo](https://github.com/mel0nyrame/deepseek-harness-desktop/blob/0971b9f0e3e9293e3f76c45b1d72f5789244ccdf/legacy/docs/defensive-patterns.md). Check races before publication, cancellation during awaits, independent error reporting, callback containment, ownership before reentry, complete detach cleanup, and quiescent disposal.
