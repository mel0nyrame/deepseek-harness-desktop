...
来源：[`packages/host/apiproxy/src/index.ts:58`](../packages/host/apiproxy/src/index.ts)
...
- `@deepseek-ai/dsh-desktop-app` — 需要 `connection` · `clientModules` · `loader`（[`packages/bundle/desktop-app/src/index.ts`](../packages/bundle/desktop-app/src/index.ts)）
