...
describe('ConversationRoot resident composer', () => {
  ...
  it('active phase: fixed header outside the scrollport; sticky composer seat inside it', () => {
    ...
    const titleRow = header?.querySelector('[data-conversation-title-row]')
    const viewTabs = header?.querySelector('[data-conversation-view-tabs]')
    ...
    expect(titleRow?.contains(b.view.getByTestId('view-conversation.session.header.actions'))).toBe(true)
    expect(titleRow?.contains(b.view.getByTestId('view-conversation.session.header.utilities'))).toBe(true)
